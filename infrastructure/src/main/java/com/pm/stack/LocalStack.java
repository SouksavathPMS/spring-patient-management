...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService(
                ...
                List.of(4500),
                authServiceDb,
                Map.of("JWT_SECRET", "8f4b0a6c3d9e72b14c5f1a2d7e8c9f01b3d4e6a7c8f9b0d1e2f3948576a1c2d3")
        );
    ...
    private CfnCluster createCluster() {
        return CfnCluster.Builder
                ...
                .kafkaVersion("3.7.x")
                .numberOfBrokerNodes(2)  // Changed from 1 to 2
                .brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
                        .instanceType("kafka.m5.xlarge")
                        .clientSubnets(vpc.getPrivateSubnets().stream()
                                .limit(2)  // Take first 2 subnets
    ...
    private FargateService createFargateService(
        ...
        if(db != null) {
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD", Objects.requireNonNull(db.getSecret()).secretValueFromJson("password").toString());
            envVars.put("SPRING_JAP_HIBERNATE_DDL_AUTO", "update");
